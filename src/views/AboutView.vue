...
<template>
  <NavBar_Component/>
  <div class="w-screen h-screen mt-8">
    <div class="h-1/2 items-center justify-center flex">
      <h1 class="text-7xl text-center font-sans text-[120px]  flex-col">bien plus qu’une agence <br> de communication <br> <p class="font-bold">360°</p></h1>
    </div>
    <div class="h-1/2 oblique-carousel-viewport">
