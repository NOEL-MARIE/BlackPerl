<template>
  <section
    class="flex flex-col  h-screen w-screen 2xl:gap-24   items-center justify-center  px-4 py-12 text-white sm:px-6 md:px-12 lg:px-24 "
  >
    <div class="flex flex-col 2xl:gap-52  lg:flex-row w-full max-w-7xl gap-8">
      ...
      <div class="flex 2xl:scale-125 2xl:mt-2 flex-col gap-4 w-full lg:w-[530px] SUPP_2XL:w-1/2">
        ...
        <router-link to="/Strategie_360" class="block">
          <div class="relative w-full h-[188px] SUPP_2XL:h-[288px] bg-black hover:scale-105 transition-transform duration-300 rounded-xl p-6 overflow-hidden">
            <div class="absolute top-4 right-4 flex items-center justify-center w-5 h-5   rounded-full bg-[#F8D065] shadow">
              <span class="text-xl  text-black font-bold animated-text">+</span>
            </div>
            <div class="flex justify-between mt-4 text-white gap-4 h-full">
              <div class="uppercase  2xl:w-1/2   text-start font-HouseOfCardsW03Bold sm:px-7 text-[clamp(1.5rem,2vw,8px)] leading-tight">
                Stratégie <br />marketing <br />360°
              </div>
              <div class="text-start font-Opensans font-light   text-[clamp(0.7rem,1.4vw,2px)] leading-snug overflow-hidden line-clamp-4 sm:line-clamp-none">
        ...
        <div class="flex flex-col sm:flex-row gap-4 2xl:gap-8">
          <router-link to="/ActivationsView" class="block w-full sm:w-1/2">
            <div class="bg-black hover:scale-105 transition-transform duration-300 rounded-xl p-4 h-[274px] w-[174px] flex flex-col justify-between">
              <div class="flex justify-end">
                <div class="w-5 h-5 rounded-full bg-[#F8D065] flex items-center justify-center">
                  <span class="text-xl text-black font-bold animated-text">+</span>
                </div>
              </div>
              <div class="flex flex-col pt-11 2xl:pt-2 gap-4">
                <div class="font-HouseOfCardsW03Bold uppercase text-start text-lg md:text-xl 2xl:text-md animated-text">
                  Activations <br />événementielles
                </div>
                <div class="text-sm font-Opensans font-light text-start 2xl:text-xs animated-text">
          ...
          <div class="w-full sm:w-1/2 h-[274px] bg-black rounded-xl overflow-hidden flex items-center justify-center">
            <img src="@/assets/images/Bateau Pirate Noir 1.png" class="object-cover h-full 2xl:w-[194px] 2xl:h-[194px] w-full" alt="" />
          </div>
        </div>
      </div>

      <!-- Colonne de droite -->
      <div class="flex 2xl:scale-125  flex-col gap-4 w-full SUPP_2XL:w-1/2">
        <div class="flex flex-col md:flex-row gap-4">
          <!-- Bloc Médias Immersifs -->
          <router-link to="/MediasImmersifsView" class="block md:w-[240px]">
            <div class="bg-black hover:scale-105 transition-transform duration-300 rounded-xl p-4 h-full flex flex-col justify-between">
              <div class="flex justify-end">
                <div class="w-5 h-5 rounded-full bg-[#F8D065] flex items-center justify-center">
                  <span class="text-xl text-black font-bold animated-text">+</span>
                </div>
              ...
              <div class="text-xs font-light font-Opensans animated-text">
                ...
                motion design…) pour capter l’attention et immerger vos audiences dans votre univers.
              </div>
            </div>
          </router-link>
          ...
          <div class="flex flex-col gap-4 w-full">
            ...
            <div class="flex flex-col sm:flex-row gap-4">
              <div class="w-full sm:w-[215px] h-[169px] bg-black rounded-xl flex items-center justify-center overflow-hidden">
                <img src="@/assets/images/bt Pirate Noir.png" alt="" class="object-cover w-[160px]" />
              </div>

              <router-link to="/BrandingContenusView" class="block w-full">
                <div class="bg-black hover:scale-105 transition-transform duration-300 rounded-xl p-4 flex flex-col justify-center h-full">
            ...
            <router-link to="/StudioCreationView" class="block">
              <div class="bg-black hover:scale-105 transition-transform duration-300 rounded-xl p-4 group flex flex-col justify-between">
                <div class="flex justify-between items-start">
                  <div class="font-HouseOfCardsW03Bold uppercase text-2xl animated-text">
        ...
        <!-- Analyse IA + Influence -->
        <div class="flex flex-col sm:flex-row gap-4 mt-4">
          <router-link to="/AnalyseIAView" class="block w-full sm:w-1/2">
            <div class="bg-black hover:scale-105 transition-transform duration-300 rounded-xl p-4 flex flex-col justify-between h-full">
              <div class="flex justify-between items-start">
                <div class="font-HouseOfCardsW03Bold uppercase text-2xl animated-text">
